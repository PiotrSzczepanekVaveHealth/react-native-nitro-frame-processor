 ...
 *
 * This API is deprecated and its documentation is included only for existing customers using it. For new integration please use
...
public:
     ...
     * \param option [in] the option ID to set. Available parameters are \ref tp_parameters
